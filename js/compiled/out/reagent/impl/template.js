...
var G__21272 = o;
(G__21272[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21276 = o;
(G__21276[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21277__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21278__i < G__21278__a.length) {G__21278__a[G__21278__i] = arguments[G__21278__i + 0]; ++G__21278__i;}
  args = new cljs.core.IndexedSeq(G__21278__a,0,null);
} 
return G__21277__delegate.call(this,args);};
G__21277.cljs$lang$maxFixedArity = 0;
G__21277.cljs$lang$applyTo = (function (arglist__21279){
var args = cljs.core.seq(arglist__21279);
return G__21277__delegate(args);
});
...
var G__21281 = props;
var G__21281__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21281,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21281);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21281__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21282){
...
var props = map__21283__$1;
var class$ = cljs.core.get.call(null,map__21283__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21283,map__21283__$1,props,class$){
return (function (c){
...
});})(map__21283,map__21283__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21285){
...
var on_write = cljs.core.get.call(null,map__21286__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21286,map__21286__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21286,map__21286__$1,on_write))
);
} else {
...
var G__21289 = jsprops;
(G__21289["defaultValue"] = value);

(G__21289["onChange"] = ((function (G__21289,v,value,on_change){
return (function (p1__21288_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21288_SHARP_);
});})(G__21289,v,value,on_change))
);
...
var vec__21292 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21292,(0),null);
var id = cljs.core.nth.call(null,vec__21292,(1),null);
var class$ = cljs.core.nth.call(null,vec__21292,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___21296 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___21296 == null)){
} else {
var key_21297 = temp__5724__auto___21296;
(jsprops["key"] = key_21297);
}
...
var temp__5724__auto___21298 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___21298 == null)){
} else {
var key_21299 = temp__5724__auto___21298;
reagent.impl.template.oset.call(null,jsprops,"key",key_21299);
}
...
var G__21300 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21300["name"] = c);
...
var len__4730__auto___21306 = arguments.length;
var i__4731__auto___21307 = (0);
while(true){
if((i__4731__auto___21307 < len__4730__auto___21306)){
args__4736__auto__.push((arguments[i__4731__auto___21307]));

var G__21308 = (i__4731__auto___21307 + (1));
i__4731__auto___21307 = G__21308;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21304){
var G__21305 = cljs.core.first.call(null,seq21304);
var seq21304__$1 = cljs.core.next.call(null,seq21304);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21305,seq21304__$1);
});
...
break;
default:
var G__21311 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21311;
continue;
...
var n__4607__auto___21313 = a.length;
var i_21314 = (0);
while(true){
if((i_21314 < n__4607__auto___21313)){
(a[i_21314] = reagent.impl.template.as_element.call(null,(a[i_21314])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21316 = a.length;
var i_21317 = (0);
while(true){
if((i_21317 < n__4607__auto___21316)){
var val_21318 = (a[i_21317]);
if(((cljs.core.vector_QMARK_.call(null,val_21318)) && ((reagent.impl.template.key_from_vec.call(null,val_21318) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21317] = reagent.impl.template.as_element.call(null,val_21318));

var G__21319 = (i_21317 + (1));
i_21317 = G__21319;
continue;
} else {
}
...
var ctx = ({});
var vec__21320 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21320,(0),null);
var derefed = cljs.core.nth.call(null,vec__21320,(1),null);
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21323){
...
//# sourceMappingURL=template.js.map?rel=1557276005287
