...
return [(function (){var pred__21440 = cljs.core.instance_QMARK_;
var expr__21441 = reactive_val;
if(cljs.core.truth_(pred__21440.call(null,reagent.ratom.RAtom,expr__21441))){
return "ra";
} else {
if(cljs.core.truth_(pred__21440.call(null,reagent.ratom.RCursor,expr__21441))){
return "rc";
} else {
if(cljs.core.truth_(pred__21440.call(null,reagent.ratom.Reaction,expr__21441))){
return "rx";
} else {
if(cljs.core.truth_(pred__21440.call(null,reagent.ratom.Track,expr__21441))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1557276005495
