...
var G__26047 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26047;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26048 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26048,ch);
...
if(("\\" === ch__$1)){
var ch_26049__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26049__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26049__$2);
} else {
}

var G__26050 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26050;
continue;
}
}
...
var vec__26058 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26058,(0),null);
var start_column = cljs.core.nth.call(null,vec__26058,(1),null);
...
var G__26061 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26061;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26062 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26063 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26063;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26062;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26064 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26064,(0),null);
var start_column = cljs.core.nth.call(null,vec__26064,(1),null);
...
var vec__26067 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26067,(0),null);
var end_column = cljs.core.nth.call(null,vec__26067,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__26070,(0),null);
var start_column = cljs.core.nth.call(null,vec__26070,(1),null);
...
var vec__26073 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26073,(0),null);
var end_column = cljs.core.nth.call(null,vec__26073,(1),null);
...
var sb = (function (){var G__26082 = (new goog.string.StringBuffer());
G__26082.append(initch);
...
var G__26084 = (function (){var G__26083 = sb;
G__26083.append(ch);

return G__26083;
})();
var G__26085 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26084;
ch = G__26085;
continue;
}
...
switch (G__26088) {
case "\\":
var G__26092 = (function (){var G__26089 = sb;
G__26089.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26089;
})();
var G__26093 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26092;
ch = G__26093;
continue;
...
break;
default:
var G__26094 = (function (){var G__26090 = sb;
G__26090.append(ch);

return G__26090;
})();
var G__26095 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26094;
ch = G__26095;
continue;
...
var vec__26096 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26096,(0),null);
var end_column = cljs.core.nth.call(null,vec__26096,(1),null);
...
var vec__26099 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26099,(0),null);
var column = cljs.core.nth.call(null,vec__26099,(1),null);
...
var vec__26104 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26104,(0),null);
var column = cljs.core.nth.call(null,vec__26104,(1),null);
...
var vec__26109 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26109,(0),null);
var column = cljs.core.nth.call(null,vec__26109,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26114 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26114,(0),null);
var start_column = cljs.core.nth.call(null,vec__26114,(1),null);
...
var vec__26117 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26117,(0),null);
var end_column = cljs.core.nth.call(null,vec__26117,(1),null);
...
var G__26120 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26120,true,null,opts,pending_forms);
...
var G__26121 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26121)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26121)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26121)){
...
var _STAR_suppress_read_STAR__orig_val__26122 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26123 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26123;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26122;
}});
...
var G__26124 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26124,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26124,rdr,first_line);
...
var G__26128 = matched;
var G__26129 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26128;
finished = G__26129;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26130 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26131 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26131;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26130;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26132 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26133 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__26133;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26134 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26134,"(");
...
var G__26135 = (i + (1));
var G__26136 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__26132;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26137 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26137);
...
var G__26138 = cljs.core.next.call(null,s__$1);
var G__26139 = ret;
s__$1 = G__26138;
r = G__26139;
continue;
...
var G__26140 = cljs.core.next.call(null,s);
var G__26141 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26140;
key_vals = G__26141;
continue;
} else {
...
var gensym_env_orig_val__26145 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26146 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__26146;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__26145;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26147 = token;
var G__26147__$1 = (((G__26147 == null))?null:cljs.core.subs.call(null,G__26147,(1)));
var G__26147__$2 = (((G__26147__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26147__$1));
var G__26147__$3 = (((G__26147__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26147__$2));
var G__26147__$4 = (((G__26147__$3 == null))?null:cljs.core.symbol.call(null,G__26147__$3));
if((G__26147__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26147__$4);
}
})():(function (){var G__26148 = token;
var G__26148__$1 = (((G__26148 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26148));
if((G__26148__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26148__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26159,reader){
...
var eof = cljs.core.get.call(null,map__26160__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___26168 = arguments.length;
var i__4731__auto___26169 = (0);
while(true){
if((i__4731__auto___26169 < len__4730__auto___26168)){
args__4736__auto__.push((arguments[i__4731__auto___26169]));

var G__26170 = (i__4731__auto___26169 + (1));
i__4731__auto___26169 = G__26170;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq26166){
var G__26167 = cljs.core.first.call(null,seq26166);
var seq26166__$1 = cljs.core.next.call(null,seq26166);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26167,seq26166__$1);
});


//# sourceMappingURL=reader.js.map?rel=1557276011062
