...
var o23884 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23884["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23885 = temp__5718__auto____$1;
return (o23885["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22994__auto__ = f;
return (o__22994__auto__["toString"]).call(o__22994__auto__);
} else {
return "";
}
...
try{var o__22994__auto___23888 = t;
(o__22994__auto___23888["cljs$lang$ctorPrWriter"]).call(o__22994__auto___23888,t,writer);
}catch (e23887){var __23889 = e23887;
}
...
var char_code = (function (){var o__22994__auto__ = (new String(char$));
return (o__22994__auto__["charCodeAt"]).call(o__22994__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22994__auto__ = String;
return (o__22994__auto__["fromCharCode"]).call(o__22994__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23890 = num_code;
switch (G__23890) {
case (1):
return (185);
...
var o__22994__auto__ = String;
return (o__22994__auto__["fromCharCode"]).call(o__22994__auto__,superscript_code);
});
/**
...
}catch (e23892){var _e__23001__auto__ = e23892;
return false;
}})())){
...
var vec__23893 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23893,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o23896 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23896["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23897 = temp__5718__auto____$1;
return (o23897["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___23904 = arguments.length;
var i__4731__auto___23905 = (0);
while(true){
if((i__4731__auto___23905 < len__4730__auto___23904)){
args__4736__auto__.push((arguments[i__4731__auto___23905]));

var G__23906 = (i__4731__auto___23905 + (1));
i__4731__auto___23905 = G__23906;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23900){
var vec__23901 = p__23900;
var ns_detector = cljs.core.nth.call(null,vec__23901,(0),null);
...
var G__23907 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23908 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23907;
remaining_tokens = G__23908;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23898){
var G__23899 = cljs.core.first.call(null,seq23898);
var seq23898__$1 = cljs.core.next.call(null,seq23898);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23899,seq23898__$1);
});
...
var vec__23912 = cljs.core.split_with.call(null,(function (p1__23911_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23911_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23912,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23912,(1),null);
...
var vec__23918 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23918,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23918,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23921 = cljs.core.rest.call(null,remaining_tokens);
var G__23922 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23921;
name_tokens = G__23922;
continue;
} else {
...
var vec__23925 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23925,(0),null);
var arity = cljs.core.nth.call(null,vec__23925,(1),null);
var vec__23928 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23928,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23928,(1),null);
var vec__23931 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23931,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23931,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23931,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23931,(3),null);
...
var vec__23937 = result;
var munged_ns = cljs.core.nth.call(null,vec__23937,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23937,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23937,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23937,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23937,(4),null);
var arity = cljs.core.nth.call(null,vec__23937,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__23941 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__23941,(0),null);
var args = cljs.core.nth.call(null,vec__23941,(1),null);
var vec__23944 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23944,(0),null);
var name = cljs.core.nth.call(null,vec__23944,(1),null);
...
var G__23947 = (arity + (1));
var G__23948 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23949){
var vec__23950 = p__23949;
var arity = cljs.core.nth.call(null,vec__23950,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23950,(1),null);
...
return cljs.core.get.call(null,arities,p1__23953_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23954_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___23961 = arguments.length;
var i__4731__auto___23962 = (0);
while(true){
if((i__4731__auto___23962 < len__4730__auto___23961)){
args__4736__auto__.push((arguments[i__4731__auto___23962]));

var G__23963 = (i__4731__auto___23962 + (1));
i__4731__auto___23962 = G__23963;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23957){
var vec__23958 = p__23957;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23958,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23955){
var G__23956 = cljs.core.first.call(null,seq23955);
var seq23955__$1 = cljs.core.next.call(null,seq23955);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23956,seq23955__$1);
});
...
var map__23966 = options;
var map__23966__$1 = (((((!((map__23966 == null))))?(((((map__23966.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23966.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23966):map__23966);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23966__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23966__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23966__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23966__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23967 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23967,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23967,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23967,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23967,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23967,(4),null);
var arity = cljs.core.nth.call(null,vec__23967,(5),null);
...
var o__22994__auto__ = f;
return (o__22994__auto__["getBasis"]).call(o__22994__auto__);
});
/**
...
}catch (e23971){var _e__23001__auto__ = e23971;
...
var G__23972 = (obj[cljs.core.first.call(null,path)]);
var G__23973 = cljs.core.rest.call(null,path);
obj = G__23972;
path = G__23973;
continue;
} else {
...
return (function (accum,p__23974){
var vec__23975 = p__23974;
var bit = cljs.core.nth.call(null,vec__23975,(0),null);
var protocol = cljs.core.nth.call(null,vec__23975,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23978){
var vec__23979 = p__23978;
var ns = cljs.core.nth.call(null,vec__23979,(0),null);
var name = cljs.core.nth.call(null,vec__23979,(1),null);
var selector = cljs.core.nth.call(null,vec__23979,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23984,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23984,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23984,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23982_SHARP_){
return (obj[cljs.core.first.call(null,p1__23982_SHARP_)]);
});})(name,sorted_matches,vec__23984,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1557276008143
